  ...
  <div class="content-container">
    ...
    <table>
      ...
      <tr v-for="damageReport in filteredDamageReports" :key="damageReport.id">
        ...
        <td v-if="!damageReport.editing">{{ damageReport.rental.id }}</td>
        <td v-else>
          <input type="text" v-model="damageReport.rental.id ">
        </td>
        ...
        <td>
          <template v-if="!damageReport.editing">
            ...
            <button @click="openDamageReportView(damageReport.id)" class="read-button button"><i class="fas fa-eye"></i>
              Read
            </button>
          </template>
